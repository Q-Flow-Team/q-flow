...
const filtered = computed(() => state.tickets.filter(t => filter.value === 'All' || t.status === filter.value))
...
<template>
  <div class="space-y-5">
    <div>
      ...
      <p class="text-sm text-muted-foreground mt-0.5">Enterprise-wide ticket history</p>
    </div>
